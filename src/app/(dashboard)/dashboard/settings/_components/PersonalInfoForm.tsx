...
//   // personal information post api integration
...
//                   className="text-white font-sm font-medium leading-[120%] tracking-[0%] font-poppins py-[10px] px-[26px] bg-[#34A1E8] rounded-[8px] "
//                 >
